...
class ManualControl(Node):
    """Node for controlling a vehicle in manual mode."""
    ...
    def __init__(self) -> None:
        ...
        # Control gains
        self.roll_angle_max = np.deg2rad(30) # in radians (max roll angle)
        self.pitch_angle_max = np.deg2rad(30)  # in radians (max pitch angle)
    ...
    def timer_callback(self) -> None:
        ...
        if self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
            ...
            thrust = (self.joystick_inputs.get_throttle() + 1.0) / 2.0
